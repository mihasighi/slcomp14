...
The main source for the benchmarks were the test suits of participants.
No industrial benchmark was included because we don't receive such a were not aware about any industrial tool using an SL solver. 
...
%% TODO: Especially analysis on which techniques worked for which benchmark categories could be insightful
...
%% TODO: say parts needs adjustement
%which parts of the format need some
...
%% TODO: industrial benchmarks
%% TODO: We added a comment on "Future work" paragraph about including more difficult 
...
%
%% TODO: For the divisions where the problems are decidable (SLL* and FDB), the
